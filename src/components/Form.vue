<template>
  <div class="container mt-5">
   ...
   <DataTable v-if="submittedCards.length" :value="submittedCards" class="mt-4" tableStyle="min-width: 50rem">
...
const validateGender = () => {
  errors.value.gender = formData.value.gender ? null : "You have to select a gender";
};
